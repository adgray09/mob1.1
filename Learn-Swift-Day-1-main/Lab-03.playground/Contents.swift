...
func printName(yourName: String) {
    print("Hello \(yourName)!")
}

// 2. Call/invoke the function you just wrote

printName(yourName: "Alex")
...
func printString(theString: String) {
    print("***\(theString)***")
}

printString(theString: "random")
...
rectangleArea(width: 25, height: 35)
...
func calculateArea(externalLength length: Int, externalWidth width: Int, externalCsPerSq csPerSq: Double) -> Double {
    let area = Double(length) * Double(width)
    return area * csPerSq
}

calculateArea(externalLength: 9, externalWidth: 6, externalCsPerSq: 0.10)
